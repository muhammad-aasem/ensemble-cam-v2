"""
DenseNet121 Training Script for NIH Chest X-ray Dataset

This script implements a comprehensive DenseNet121 fine-tuning pipeline optimized for
...
=== MODEL ARCHITECTURE ===
- Base: torchvision.models.densenet121 (ImageNet pre-trained)
- Modifications:
...
- Model Checkpointing: Best weights saved to models/densenet121_best.pth

=== GRAD-CAM++ COMPATIBILITY ===
- Preserves intermediate feature maps in DenseNet121 layers
...
=== MODEL PERSISTENCE ===
- Saves best model weights: models/densenet121_best.pth
...
=== OUTPUT STRUCTURE ===
models/
├── densenet121_best.pth        # Best model weights
...
class DenseNet121Classifier(nn.Module):
    """DenseNet121 model modified for chest X-ray classification."""
...
class ModelTrainer:
    """Main training class for DenseNet121 chest X-ray classification."""
    ...
    def __init__(self, config: Dict):
        ...
        # Initialize paths - models saved to models/densenet121 directory
        self.data_dir = Path(config['data_dir'])
        self.models_dir = Path(config['models_dir']) / 'densenet121'
    ...
    def initialize_model(self) -> DenseNet121Classifier:
        ...
        checkpoint_path = self.models_dir / 'densenet121_best.pth'
    ...
    def initialize_optimizer_and_scheduler(self, model: DenseNet121Classifier, 
    ...
    def train_epoch(self, model: DenseNet121Classifier, train_loader: DataLoader,
    ...
    def validate_epoch(self, model: DenseNet121Classifier, val_loader: DataLoader,
    ...
    def save_checkpoint(self, model: DenseNet121Classifier, optimizer: optim.Optimizer,
        ...
        torch.save(checkpoint, self.models_dir / 'densenet121_latest.pth')
        
        # Save best checkpoint - only save if better than previous best
        if is_best:
            torch.save(checkpoint, self.models_dir / 'densenet121_best.pth')
    ...
    def evaluate_model(self, model: DenseNet121Classifier, test_loader: DataLoader) -> Dict:
    ...
    def train(self):
        ...
        print("Starting DenseNet121 training for chest X-ray classification...")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train DenseNet121 on NIH Chest X-ray dataset')
    ...
    print("DenseNet121 Training for NIH Chest X-ray Dataset")
    print("=" * 60)
    print(f"Dataset directory: {data_dir}")
    print(f"Models directory: {args.models_dir}/densenet121")
